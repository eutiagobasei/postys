import { RedditSettingsDto } from '@postys/nestjs-libraries/dtos/posts/providers-settings/reddit.dto';
import { PinterestSettingsDto } from '@postys/nestjs-libraries/dtos/posts/providers-settings/pinterest.dto';
import { YoutubeSettingsDto } from '@postys/nestjs-libraries/dtos/posts/providers-settings/youtube.settings.dto';
import { TikTokDto } from '@postys/nestjs-libraries/dtos/posts/providers-settings/tiktok.dto';
import { XDto } from '@postys/nestjs-libraries/dtos/posts/providers-settings/x.dto';
import { LemmySettingsDto } from '@postys/nestjs-libraries/dtos/posts/providers-settings/lemmy.dto';
import { DribbbleDto } from '@postys/nestjs-libraries/dtos/posts/providers-settings/dribbble.dto';
import { DiscordDto } from '@postys/nestjs-libraries/dtos/posts/providers-settings/discord.dto';
import { SlackDto } from '@postys/nestjs-libraries/dtos/posts/providers-settings/slack.dto';
import { KickDto } from '@postys/nestjs-libraries/dtos/posts/providers-settings/kick.dto';
import { TwitchDto } from '@postys/nestjs-libraries/dtos/posts/providers-settings/twitch.dto';
...
import { MediumSettingsDto } from '@postys/nestjs-libraries/dtos/posts/providers-settings/medium.settings.dto';
...
import { GmbSettingsDto } from '@postys/nestjs-libraries/dtos/posts/providers-settings/gmb.settings.dto';
import { FarcasterDto } from '@postys/nestjs-libraries/dtos/posts/providers-settings/farcaster.dto';
