...
- **[Discord chat](https://discord.postys.io)**: To chat with people [Discord chat](https://discord.postys.io/) and a quicker feedback.
...
2. **Clone your fork:** Bring a copy of your fork to your local machine.
   ```bash
   git clone https://github.com/YOUR_USERNAME/postys.git
   ```
...
Again, do check the [developer guide](https://docs.postys.io/developer-guide). Much of what you probably need to know is in there.

If you encounter any issues, please visit our [support page](https://docs.postys.io/support) or check the community forums. Your contributions help make Postys better!
