# Postys CLI - Feature Summary

## ✅ Complete Feature Set

### Posts with Comments and Media - FULLY SUPPORTED

The Postys CLI **fully supports** the complete API structure including:
...
postys posts:create -c "Post" --image "img1.jpg,img2.jpg,img3.jpg" -i "twitter-123"

# With comments (no custom media per comment)
postys posts:create -c "Main" --comments "Comment 1;Comment 2" -i "twitter-123"
```
...
- ✅ Fully compatible with the Postys API structure

The CLI supports the **complete Postys API** including all advanced features!
