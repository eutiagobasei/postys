...
```bash
postys integrations:settings youtube-def456
```
...
```bash
postys integrations:settings twitter-ghi789
```
...
```bash
postys integrations:settings linkedin-jkl012
```
...
```bash
postys integrations:settings tiktok-mno345
```
...
```bash
postys integrations:settings instagram-pqr678
```
...
```bash
postys integrations:settings threads-stu901
```
...
postys integrations:settings reddit-456
```
...
```bash
postys integrations:settings twitter-789 | jq '.output.maxLength'
# Output: 280
```
...
SETTINGS=$(postys integrations:settings reddit-123)
...
```bash
postys integrations:settings invalid-id
...
```bash
postys integrations:settings reddit-123
