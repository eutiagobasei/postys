...
# Postys CLI - Command Line Examples
# Demonstrating the new -c and -m flag syntax

echo "🚀 Postys CLI Command Line Examples"
echo ""
...
echo "Command:"
echo 'postys posts:create -c "Hello World!" -i "twitter-123"'
echo ""

# Example 2: Post with multiple images
echo "📸 Example 2: Post with multiple images"
echo "Command:"
echo 'postys posts:create \'
...
echo "Command:"
echo 'postys posts:create \'
echo '  -c "🧵 How to use Postys CLI (1/5)" \'
