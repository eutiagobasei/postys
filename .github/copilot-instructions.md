...
# Copilot Coding Agent Instructions for Postys
...
- SDK (`apps/sdk`) provides programmatic access to Postys features.
...
## Documentation
- Main docs: https://docs.postys.io/
- Developer guide: https://docs.postys.io/developer-guide
- Public API: https://docs.postys.io/public-api
